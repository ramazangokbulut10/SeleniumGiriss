...
public class C01_IlkClass {
    public static void main(String[] args) {
        ...
        // Mobil uygulamalarını "Appium" ile test ederiz.
        ...
        ve method'un içine ilk olarak driver'i yazarız. İkinci olarak onun fiziki yolunu kopyalarız
                           Key                          Value
         */
        // Resources altındaki drivers package'nin içindeki "chromedriver.exe" aşağıdaki adımı uygularız.
        ...
        WebDriver driver=new ChromeDriver(); // WebDriver interface olduğu icin tek basina obje olusturamiyoruz
